...
/**
 * 忘记密码
 * Created by lsj on 2016/3/15.
 */
public class UserForgetPasswordActivity extends MyBaseActivity implements View.OnClickListener,Handler.Callback{
    ...
    protected void initView() {
        ...
        mTxtForgetPwd = (TextView) findViewById(R.id.txt_forget_password);
        mTxtTopTitle = (TextView) findViewById(R.id.txt_register_or_forget_password_title);
    ...
    protected void initData() {
        mTxtForgetPwd.setText("确定");
        mTxtTopTitle.setText("忘记密码");
...
//                userRegister();
    ...
    private void userRegister(){
        RequestParams params = new RequestParams(Conts.POST_FORGET_PASSWORD);
...
//                MyToast.showToast(mContext, s);
                ...
                switch (bean.getResultCode()){
                    case 101:
                        MyToast.showToast(mContext, "手机号不存在存在");
                        break;
                    case 1:
                        MyToast.showToast(mContext, "成功");
                        break;
                    case 0:
                        MyToast.showToast(mContext, "失败");
                        break;
                }
            }
            @Override
